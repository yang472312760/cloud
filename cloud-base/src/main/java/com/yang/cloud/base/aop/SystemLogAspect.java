package com.yang.cloud.base.aop;

import com.yang.cloud.base.annotation.SystemLog;
import com.yang.cloud.base.enums.system.LogType;
import com.yang.cloud.base.enums.system.OperateType;
import com.yang.cloud.base.model.system.CommonResult;
import com.yang.cloud.base.model.system.UserLog;
import com.yang.cloud.base.service.userlog.IUserLogService;
...
@Component
@Slf4j
@ConditionalOnExpression("${yang.log.enabled}")
public class SystemLogAspect {
    ...
    @AfterReturning(pointcut = "execution (* com.yang.cloud..controller.*Controller.*(..))", returning = "result")
